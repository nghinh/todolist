...
export const metadata: Metadata = {
  title: "Hôm nay | TodoList",
  description: "Task hôm nay, quá hạn và sắp tới — tập trung vào việc cần làm.",
};
...
export default async function TodayPage() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-slate-950 text-white" role="main" aria-label="What to do today" suppressHydrationWarning>
      ...
      <div className="container mx-auto max-w-2xl px-4 py-8 sm:py-12" suppressHydrationWarning>
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4" suppressHydrationWarning>
          <h1 className="text-2xl font-bold tracking-tight text-slate-100 sm:text-3xl">Hôm nay</h1>
